...
return 0. + (0.75*MT2*A0i(aa0, MT2)*Cos(alp - beta)*Cot(beta))/(MA02*Pi2*v2) + 
 ...
 (0.09375*MW2*C0i(cc0, m12, m32, m22, Mh2, Mh2, MW2)*
   (4*Mh2 + (M2*Cos(alp - 3*beta) + (M2 - Mh2)*Cos(3*alp - beta) + 
      (2*M2 - 3*Mh2)*Cos(alp + beta))*Csc(beta)*(pow(Sin(alp - beta), 2))*
     Sec(beta)))/(Pi2*v2) + (0.75*Cos(alp)*Csc(beta)*(pow(MB, 4))*
   Re(B0i(bb0, Mh2, MB2, MB2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) + (0.75*Cos(alp)*Csc(beta)*(pow(MC, 4))*
   Re(B0i(bb0, Mh2, MC2, MC2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) + (0.75*Cos(alp)*Csc(beta)*(pow(MD, 4))*
   Re(B0i(bb0, Mh2, MD2, MD2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) + (0.25*Cos(alp)*Csc(beta)*(pow(ME, 4))*
   Re(B0i(bb0, Mh2, ME2, ME2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) + (0.25*Cos(alp)*Csc(beta)*(pow(ML, 4))*
   Re(B0i(bb0, Mh2, ML2, ML2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) + (0.25*Cos(alp)*Csc(beta)*(pow(MM, 4))*
   Re(B0i(bb0, Mh2, MM2, MM2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) + (0.75*Cos(alp)*Csc(beta)*(pow(MS, 4))*
   Re(B0i(bb0, Mh2, MS2, MS2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) + (0.75*Cos(alp)*Csc(beta)*(pow(MT, 4))*
   Re(B0i(bb0, Mh2, MT2, MT2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) + (0.75*Cos(alp)*Csc(beta)*(pow(MU, 4))*
   Re(B0i(bb0, Mh2, MU2, MU2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) - (0.75*Cos(alp)*Csc(beta)*(pow(MB, 4))*
   Re(B0i(bb0, MHH2, MB2, MB2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) - (0.75*Cos(alp)*Csc(beta)*(pow(MC, 4))*
   Re(B0i(bb0, MHH2, MC2, MC2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) - (0.75*Cos(alp)*Csc(beta)*(pow(MD, 4))*
   Re(B0i(bb0, MHH2, MD2, MD2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) - (0.25*Cos(alp)*Csc(beta)*(pow(ME, 4))*
   Re(B0i(bb0, MHH2, ME2, ME2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) - (0.25*Cos(alp)*Csc(beta)*(pow(ML, 4))*
   Re(B0i(bb0, MHH2, ML2, ML2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) - (0.25*Cos(alp)*Csc(beta)*(pow(MM, 4))*
   Re(B0i(bb0, MHH2, MM2, MM2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) - (0.75*Cos(alp)*Csc(beta)*(pow(MS, 4))*
   Re(B0i(bb0, MHH2, MS2, MS2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) - (0.75*Cos(alp)*Csc(beta)*(pow(MT, 4))*
   Re(B0i(bb0, MHH2, MT2, MT2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) - (0.75*Cos(alp)*Csc(beta)*(pow(MU, 4))*
   Re(B0i(bb0, MHH2, MU2, MU2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) - (0.375*MHH2*Cos(alp)*Csc(beta)*(pow(MB, 2))*
   Re(B0i(bb1, MHH2, MB2, MB2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) - (0.375*MHH2*Cos(alp)*Csc(beta)*(pow(MC, 2))*
   Re(B0i(bb1, MHH2, MC2, MC2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) - (0.375*MHH2*Cos(alp)*Csc(beta)*(pow(MD, 2))*
   Re(B0i(bb1, MHH2, MD2, MD2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) - (0.125*MHH2*Cos(alp)*Csc(beta)*(pow(ME, 2))*
   Re(B0i(bb1, MHH2, ME2, ME2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) - (0.125*MHH2*Cos(alp)*Csc(beta)*(pow(ML, 2))*
   Re(B0i(bb1, MHH2, ML2, ML2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) - (0.125*MHH2*Cos(alp)*Csc(beta)*(pow(MM, 2))*
   Re(B0i(bb1, MHH2, MM2, MM2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) - (0.375*MHH2*Cos(alp)*Csc(beta)*(pow(MS, 2))*
   Re(B0i(bb1, MHH2, MS2, MS2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) - (0.375*MHH2*MT2*Cos(alp)*Csc(beta)*
   Re(B0i(bb1, MHH2, MT2, MT2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) - (0.375*MHH2*Cos(alp)*Csc(beta)*(pow(MU, 2))*
   Re(B0i(bb1, MHH2, MU2, MU2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) + (0.0625*(Mh2 - MHH2)*A0i(aa0, MW2)*
...
return 0. + (0.75*MT2*A0i(aa0, MT2)*Cos(alp - beta)*Cot(beta))/(MA02*Pi2*v2) + 
 ...
 (0.041666666666666664*C0i(cc2, m22, m32, m12, MD2, MD2, MD2)*
  ...
  (Pi2*v2) + (0.25*A0i(aa0, ME2)*Cos(alp - beta)*Cot(beta)*(pow(ME, 2)))/
  (MA02*Pi2*v2) + (0.125*B0i(bb1, MA02, ME2, ME2)*Cos(alp - beta)*Cot(beta)*
   (pow(ME, 2)))/(Pi2*v2) + 
 ...
 (0.09375*MW2*C0i(cc0, m12, m32, m22, Mh2, Mh2, MZ2)*(pow(Cos(w), 2))*
  ...
  (Pi2*v2*(pow(Csc(w), 4))) + (0.75*Cos(alp)*Csc(beta)*(pow(MB, 4))*
   Re(B0i(bb0, Mh2, MB2, MB2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) + (0.75*Cos(alp)*Csc(beta)*(pow(MC, 4))*
   Re(B0i(bb0, Mh2, MC2, MC2))*Sin(alp)*(Cos(alp)*Cot(beta) + Sin(alp)))/
  ((Mh2 - MHH2)*Pi2*v2) + (0.75*Cos(alp)*Csc(beta)*(pow(MD, 4))*
 ...
 (0.125*MW2*Csc(2*w)*Re(B0i(bb1, MW2, 0, MW2))*(1 + Sin(alp - beta))*
   Sin(4*w))/(Pi2*v2) + (0.010416666666666666*Cos(w)*(pow(Sin(w), 3))*
   Re(A0i(aa0, MT2))*(-((7 + Cos(2*w) + 8*Cos(4*w) + 2*Cos(6*w))*
      (pow(Csc(w), 5))*Sec(w)) + 2*(pow(MA02, -1))*
     (-36*MT2*(pow(Cos(alp), 3))*(pow(Cot(beta), 2))*
       (pow(Csc(w), 4)) + Cos(alp)*(-32*MA02 + 
        80*MA02*(pow(Csc(w), 2)) + 9*MA02*(pow(Csc(w), 6)) - 
        3*(pow(Csc(w), 4))*(17*MA02 + 12*MT2*(pow(Cot(beta), 2))*
           (pow(Sin(alp), 2)))) - 36*MT2*Cot(beta)*(pow(Cos(alp), 2))*
...
return 0. + (0.03125*(4*Mh2*MT2 - (m12 + m22 - m32)*MW2 + MHp2*(-4*MT2 + 2*MW2))*
 ...
 (0.03125*B0i(bb0, m32, MT2, MW2)*(-4*(MT2 + MW2) + 
  ...
  (Pi2*v2) + (0.25*C0i(cc0, m12, m32, m22, MT2, MT2, MW2)*
 ...
 (0.015625*(16*Csc(beta)*(pow(MM, 2))*(pow(Cos(alp), 3))*
  ...
  (MA02*Pi2*v2) + (0.005208333333333333*
   (144*Csc(beta)*(pow(MS, 2))*(pow(Cos(alp), 3))*
     (pow(Cot(beta), 2)) + 
    MA02*(61 + 4*Cos(alp)*(-12 + 2*Cos(2*w) + Cos(4*w))*Csc(beta))*
     (pow(Cot(w), 2)) + (MA02*(-93 + 61*Cos(2*w) - 20*Cos(4*w) + 
       2*Cos(6*w))*(pow(Csc(w), 2)))/2 + 8*Cos(alp)*Csc(beta)*
...
return 0. - (0.03125*(m12 - m22 - m32)*MW2*C0i(cc1, m22, m32, m12, MHp2, MS2, MW2)*
 ...
 (0.03125*(5*m12 + m22 - m32)*MW2*C0i(cc2, m32, m22, m12, MHp2, MS2, MW2)*
   Cos(alp - beta)*Cot(beta))/(Pi2*v2) + 1.*(-1 + Cos(alp)*Csc(beta)) + 
 (0.125*m12*C0i(cc1, m12, m32, m22, MS2, MS2, MW2)*(-1 + Cos(alp)*Csc(beta))*
   (pow(MS, 2)))/(Pi2*v2) + 
...
return 0. + (0.03125*(m12 - m22 - m32)*MW2*C0i(cc1, m22, m12, m32, MB2, MHp2, MW2)*
 ...
 (0.25*C0i(cc0, m12, m32, m22, MB2, MB2, MW2)*(-1 + Cos(alp)*Csc(beta))*
   (pow(MB, 4)))/(Pi2*v2) + 
 (0.0625*C0i(cc0, m32, m12, m22, MB2, MHp2, MW2)*Cos(alp - beta)*Cot(beta)*
...
return 0. + (2.6666666666666665*MT2*MW2*B0i(bb0, m32, MT2, MT2)*
 ...
 (0.5*(m12 + m22 - m32)*C0i(cc1, m22, m32, m12, MW2, MW2, MW2)*
   ...
   (pow(Sin(w), 2)))/(Pi2*(pow(v, 3))) + 
 (0.5*MW2*(Mh2 + 6*MW2)*B0i(bb0, m12, MW2, MW2)*(pow(Sin(w), 2))*
