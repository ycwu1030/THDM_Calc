...
return 0. + (0.75*MT2*A0i(aa0, MT2)*Cos(alp - beta)*Cot(beta))/(MA02*Pi2*v2) + 
 ...
 (0.1875*C0i(cc0, m12, m32, m22, MD2, MD2, MU2)*(pow(MD, 2))*
  ...
  (Pi2*v2) - (0.25*B0i(bb0, m32, 0, ME2)*(pow(ME, 2))*Sec(beta)*
 ...
 (1.5*C0i(cc00, m22, m12, m32, MC2, MS2, MS2)*(pow(MS, 2))*Sec(beta)*
   (Cos(beta) + Sin(alp)))/(Pi2*v2) + 
 ...
 (0.015625*Re(A0i(aa0, MM2))*(-21*MA02 + MA02*(-8 - 10*Cos(4*w) + Cos(6*w))*
  ...
  (MA02*Pi2*v2) - (0.005208333333333333*(pow(Sin(w), 3))*
   Re(A0i(aa0, MB2))*(MA02*(-56 + 11*Cos(2*w) + 10*Cos(4*w) - Cos(6*w))*
     (pow(Csc(w), 5))*(1 + Cos(beta)*Sin(alp)) + 
    48*MA02*Cos(alp)*Csc(w)*(pow(Cot(w), 2))*Sin(beta) + 
    4*(pow(Csc(w), 3))*Sin(beta)*(-36*(pow(MB, 2))*
       (pow(Cos(alp), 3)) + Cos(alp)*(17*MA02 + 2*MA02*Cos(2*w) - 
        MA02*Cos(4*w) - 9*(pow(MB, 2)) + 9*MA02*(pow(Cot(w), 2))) - 
 ...
 (0.005208333333333333*Cos(w)*(pow(Sin(w), 3))*Re(A0i(aa0, MB2))*
   ...
   (-128*MA02*Cos(alp)*Csc(w)*Sec(w)*Sin(beta) + MA02*(pow(Csc(w), 5))*
    ...
    6*(MA02*Cos(alp + beta) + Cos(alp - beta)*(MA02 - 24*(pow(MS, 2))))*
     (pow(Csc(w), 3))*Sec(w)*Tan(beta) + 32*MA02*Cos(alp)*Sin(beta)*
     Tan(w)))/(MA02*Pi2*v2) - (0.015625*Cos(w)*(pow(Sin(w), 3))*
   Re(A0i(aa0, ME2))*(-64*MA02*Cos(alp)*Csc(w)*Sec(w)*Sin(beta) + 
    MA02*(pow(Csc(w), 5))*Sec(w)*(4 + Cos(6*w) + 4*Cos(beta)*Sin(alp) + 
      Cos(beta)*Cos(6*w)*Sin(alp) - 11*Cos(2*w)*(1 + Cos(beta)*Sin(alp)) + 
...
return 0. + (0.0625*(m12 + m22 - m32 - 4*MT2)*MT2*C0i(cc0, m22, m12, m32, MHp2, MT2, 
 ...
 (0.75*A0i(aa0, MD2)*(pow(MD, 2))*(pow(Tan(beta), 2))*Sec(beta)*
   ...
   (pow(Tan(beta), 2))*Sec(beta)*Sin(alp))/(Pi2*v2) + 
 (0.25*A0i(aa0, ME2)*(pow(ME, 2))*(pow(Tan(beta), 2))*Sec(beta)*
   Sin(alp))/(MA02*Pi2*v2) + (0.125*B0i(bb1, MA02, ME2, ME2)*(pow(ME, 2))*
   (pow(Tan(beta), 2))*Sec(beta)*Sin(alp))/(Pi2*v2) + 
...
return 0. - (0.03125*(m12 - m22 - m32)*MW2*C0i(cc1, m22, m32, m12, MHp2, MS2, MW2)*
 ...
 (0.375*B0i(bb1, MA02, MB2, MB2)*Cos(alp)*Csc(beta)*(pow(MB, 2)))/
  ...
  (MA02*Pi2*v2) + (0.375*B0i(bb1, MA02, MD2, MD2)*Cos(alp)*Csc(beta)*
   (pow(MD, 2)))/(Pi2*v2) + (0.25*A0i(aa0, ME2)*Cos(alp)*Csc(beta)*
 ...
 (0.125*B0i(bb1, MA02, MM2, MM2)*Cos(alp)*Csc(beta)*(pow(MM, 2)))/
  ...
  (MA02*Pi2*v2) + (0.375*B0i(bb1, MA02, MS2, MS2)*Cos(alp)*Csc(beta)*
   (pow(MS, 2)))/(Pi2*v2) - 
 (0.0625*C0i(cc0, m12, m32, m22, MHp2, MHp2, MS2)*
   ((Mh2 - 2*MHp2)*Cos(alp - 3*beta) + (-4*M2 + 3*Mh2 + 2*MHp2)*
 ...
 (0.015625*(16*MA02 - MA02*Cos(6*w) - 16*MA02*Cos(alp)*Csc(beta) + 
    MA02*Cos(alp)*Cos(6*w)*Csc(beta) - 10*MA02*Cos(4*w)*
     (-1 + Cos(alp)*Csc(beta)) + Cos(2*w)*(-29*MA02 + 
      Cos(alp)*Csc(beta)*(29*MA02 - 8*(pow(ME, 2)))) + 
...
return 0. + (0.03125*(m12 - m22 - m32)*MW2*C0i(cc1, m22, m12, m32, MB2, MHp2, MW2)*
 ...
 (0.125*B0i(bb1, MA02, ML2, ML2)*Cos(alp)*Csc(beta)*(pow(ML, 2)))/
  ...
  (MA02*Pi2*v2) + (0.125*B0i(bb1, MA02, MM2, MM2)*Cos(alp)*Csc(beta)*
   (pow(MM, 2)))/(Pi2*v2) + (0.75*A0i(aa0, MS2)*Cos(alp)*Csc(beta)*
...
return 0. + (2.6666666666666665*MT2*MW2*B0i(bb0, m32, MT2, MT2)*
 ...
 (0.6666666666666666*MW2*B0i(bb0, m32, MB2, MB2)*(pow(MB, 2))*
  ...
  (Pi2*(pow(v, 3))) - (0.6666666666666666*(m12 + m22 - m32)*MW2*
   ...
   (pow(Sin(w), 2))*Sec(beta)*(Cos(beta) + Sin(alp)))/
  (Pi2*(pow(v, 3))) - (2.*MW2*B0i(bb0, m32, ME2, ME2)*(pow(ME, 2))*
   (pow(Sin(w), 2))*Sec(beta)*(Cos(beta) + Sin(alp)))/
